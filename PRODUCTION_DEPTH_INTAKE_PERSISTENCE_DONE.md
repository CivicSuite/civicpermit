...
- Persisted intake create/read routes require `X-CivicPermit-Role: staff` when `CIVICPERMIT_INTAKE_DB_URL` is configured.
...
- API persistence, staff-role gating, and retrieval tests passed.
