"""Static public UI shell for CivicPermit v0.1.1."""
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .card { grid-column:span 6; min-width:0; padding:24px; border:1px solid var(--line); border-radius:28px; background:rgba(255,253,247,.92); box-shadow:0 18px 40px rgba(35,43,50,.10); }
  ...
  textarea { background:#f3f7f8; color:var(--ink); }
...
<header>
  ...
  <p><span class="badge">v0.1.1 permit intake foundation</span></p>
</header>
<main id="main" tabindex="-1">
  <section class="grid" aria-labelledby="lookup-title">
    <article class="card large">
      ...
      <textarea aria-label="Sample proposal" rows="4">Applicant proposes an ADU at 100 Main Street with a site plan and utility description.</textarea>
      <button type="button">Review sample intake</button>
