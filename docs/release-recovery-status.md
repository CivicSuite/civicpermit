...
| --- | --- | --- |
| Public claim recovery | Passing locally | README, text README, user manual, docs landing page, changelog, and docs checks now describe the recovered v1.0.0 label without overstating permit approvals, official completeness determinations, fee calculations, inspections, legal advice, live GIS, live LLM calls, permit-system writeback, or system-of-record behavior. |
